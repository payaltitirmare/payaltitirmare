...
<!-- Mirrored from pixinvent.com/apex-angular-4-bootstrap-admin-template/html-demo-2/login-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Apr 2018 07:16:29 GMT -->
<head>
                            ...
                            <form>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <button type="submit" class="btn btn-secondary btn-block btn-raised">Cancel</button>
                                    </div>
                                </div>
                            </form>
                        </div>
