                ...
                <div class="card-body">
                    <div class="card-block">
                        ...
                        <table class="table table-responsive-md text-center " >
                          ...
                          <td><a  href="DeleteCategory.jsp?id=<%=resultset.getString(1) %>"><i class="ft-trash font-medium-3 red"></i>Delete</a> ||
                          
                               <!--   <td> <a  href="EditCategory.jsp?id=<%=resultset.getString(1) %>"><i class="ft-edit orange"></i></a> </td> -->
                               <a  href="Addcategory?id=<%=resultset.getString(1) %>"><i class="ft-edit orange"></i>Edit</a></td>
