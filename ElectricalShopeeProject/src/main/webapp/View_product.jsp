                         ...
                         {                 
                        	        %>    <tr>    
                        	                    <td> <%= rs.getInt("prod_id") %></td>
                                                  ...
                                                  <td> <a href="Productoperation?action=DELETE&id=<%=rs.getString("prod_id")%>"><i class="ft-trash font-medium-3 red"></i>Delete </a>||</td>
                                                  
                                                 <td><a href="Productoperation?action=EDIT&id=<%=rs.getString("prod_id")%> %>" ><i class="ft-edit orange"></i>Edit</a> </td>
                                                </tr>
                                              <%
                                                 }
